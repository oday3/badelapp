 ...
 * Use the [BidOrdersFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BidOrdersFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private var binding: FragmentBidOrdersBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentBidOrdersBinding.inflate(inflater, container, false)
        ...
        binding?.recListOfBidOrders?.adapter = ordersAdapter

        orderData[ApiConstants.PAR_FILTER_TYPE] = 1.toString()
    ...
    private fun rateOrder(item: OrderItem) {
       ...
       // (requireActivity() as MainActivity).mRatedOrderId = item.id ?: -1
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.recListOfBidOrders?.addOnScrollListener(object :
            RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                if (dy > 0) {

                    if ((binding?.recListOfBidOrders?.layoutManager as LinearLayoutManager).itemCount > 0) {
                        if (!isLoading && hasMore && (binding?.recListOfBidOrders?.layoutManager as LinearLayoutManager).findLastCompletelyVisibleItemPosition() == ordersAdapter.itemCount - 1) {
                            isLoading = true
        ...
        binding?.edtBidOrdersFragmentSearch?.addSearchListener {
        ...
        binding?.imgSearchAction?.setOnClickListener {
            ...
            if (it.tag == "search") {
                ...
                if (validateEmpty(binding?.edtBidOrdersFragmentSearch!!)) {
                ...
                binding?.edtBidOrdersFragmentSearch?.setText("")
                mCurrentPage = 1
    ...
    companion object {
         ...
         * @return A new instance of fragment BidOrdersFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BidOrdersFragment().apply {
    ...
    fun getOrders(params: HashMap<String, String>,  refreshData: Boolean = true, hideAllLayout: Boolean = false) {
    ...
    private fun showEmptyLayout() {
        ...
        binding?.recListOfBidOrders?.showView(false)
    ...
    private fun hideEmptyLayout() {
        ...
        binding?.recListOfBidOrders?.showView(true)
    ...
    fun executeSearchCommand() {
        ...
        isFilterSelected = false
        mCurrentPage = 1
        orderData[ApiConstants.PAR_DATA] = binding?.edtBidOrdersFragmentSearch?.text.toString()
        orderData[ApiConstants.PAR_PAGE] = mCurrentPage.toString()
        orderData.remove(ApiConstants.PAR_STATUS)
