 ...
 * Use the [BuyTransactionsFrag.newInstance] factory method to
 * create an instance of this fragment.
 */
class BuyTransactionsFrag : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null

    private var binding: FragmentBuyTransactionsBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentBuyTransactionsBinding.inflate(inflater, container, false)

        transactionsAdapter = TransactionsAdapter(requireContext(), ::chatAction, null)
        binding?.recListOfBuyTransactions?.adapter = transactionsAdapter
        requestParameters[ApiConstants.PAR_FILTER_TYPE] = 3.toString()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.recListOfBuyTransactions?.addOnScrollListener(object :
            RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                if (dy > 0) {

                    if ((binding?.recListOfBuyTransactions?.layoutManager as LinearLayoutManager).itemCount > 0) {
                        if (!isLoading && hasMore && (binding?.recListOfBuyTransactions?.layoutManager as LinearLayoutManager).findLastCompletelyVisibleItemPosition() == transactionsAdapter.itemCount - 1) {
                            isLoading = true
    ...
    private fun hideEmptyLayout() {
        ...
        binding?.recListOfBuyTransactions?.showView(true)
    ...
    companion object {
         ...
         * @return A new instance of fragment BuyTransactionsFrag.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BuyTransactionsFrag().apply {
