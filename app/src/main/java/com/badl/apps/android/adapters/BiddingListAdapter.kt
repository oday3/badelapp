...
class BiddingListAdapter(val context: Context) : RecyclerView.Adapter<BiddingListAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(var binding: ListItemProductSectionHorizantalBinding) :
