...
import com.badl.apps.android.databinding.FragmentBuyTransactionsBinding
import com.badl.apps.android.databinding.FragmentCharityTransactionsBinding
 ...
 * Use the [CharityTransactionsFrag.newInstance] factory method to
 * create an instance of this fragment.
 */
class CharityTransactionsFrag : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null

    private var binding: FragmentCharityTransactionsBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentCharityTransactionsBinding.inflate(inflater, container, false)

        transactionsAdapter = TransactionsAdapter(requireContext(), ::chatAction,  null)
        binding?.recListOfCharityTransactions?.adapter = transactionsAdapter
        requestParameters[ApiConstants.PAR_FILTER_TYPE] = 4.toString()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.recListOfCharityTransactions?.addOnScrollListener(object :
            RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                if (dy > 0) {

                    if ((binding?.recListOfCharityTransactions?.layoutManager as LinearLayoutManager).itemCount > 0) {
                        if (!isLoading && hasMore && (binding?.recListOfCharityTransactions?.layoutManager as LinearLayoutManager).findLastCompletelyVisibleItemPosition() == transactionsAdapter.itemCount - 1) {
                            isLoading = true
    ...
    private fun hideEmptyLayout() {
        ...
        binding?.recListOfCharityTransactions?.showView(true)
    ...
    companion object {
         ...
         * @return A new instance of fragment CharityTransactionsFrag.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CharityTransactionsFrag().apply {
