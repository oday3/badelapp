...
import com.badl.apps.android.databinding.FragmentBuyAdsBinding
 ...
 * Use the [BuyAdsFragment.newInstance] factory method to
...
class BuyAdsFragment : Fragment() {
    ...
    private var binding: FragmentBuyAdsBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentBuyAdsBinding.inflate(inflater, container, false)

        adsAdapter = MyAdsAdapter(requireContext(), 1, ::clickAction, ::editAction, ::deleteAction, :: checkIsDataEmpty)
        binding?.recListOfBuyOrders?.adapter = adsAdapter
        adParameters[ApiConstants.PAR_FILTER_TYPE] = 3.toString()
            ...
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                if (dy > 0) {
                    ...
                    if ((binding?.recListOfBuyOrders?.layoutManager as LinearLayoutManager).itemCount > 0) {
                        if (!isLoading && hasMore && (binding?.recListOfBuyOrders?.layoutManager as LinearLayoutManager).findLastCompletelyVisibleItemPosition() == adsAdapter.itemCount - 1) {
                            isLoading = true
    ...
    private fun clickAction(position: Int) {
        ...
        getIntentExtension(AdOrdersActivity::class.java).run {
            ...
            putExtra(Constants.FROM, Constants.FROM_BUY_ORDERS)
            startActivity(this)
        }
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment BuyAdsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BuyAdsFragment().apply {
    ...
    private fun showEmptyLayout() {
        ...
        binding?.consBuyAdsFragContent?.showView(false)
    ...
    private fun hideEmptyLayout() {
        binding?.consBuyAdsFragContent?.showView(true)
