...
import com.badl.apps.android.databinding.FragmentCharityOrdersBinding
 ...
 * Use the [CharityOrdersFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CharityOrdersFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null

    private var binding: FragmentCharityOrdersBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentCharityOrdersBinding.inflate(inflater, container, false)
        ...
        binding?.recListOfCharityOrders?.adapter = ordersAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                if (dy > 0) {
                    ...
                    if ((binding?.recListOfCharityOrders?.layoutManager as LinearLayoutManager).itemCount > 0) {
                        if (!isLoading && hasMore && (binding?.recListOfCharityOrders?.layoutManager as LinearLayoutManager).findLastCompletelyVisibleItemPosition() == ordersAdapter.itemCount - 1) {
                            isLoading = true
        ...
        binding?.edtCharityOrdersFragmentSearch?.addSearchListener {
        ...
        binding?.imgSearchAction?.setOnClickListener {
            ...
            if (it.tag == "search") {
                ...
                if (validateEmpty(binding?.edtCharityOrdersFragmentSearch!!)) {
                ...
                binding?.edtCharityOrdersFragmentSearch?.setText("")
                mCurrentPage = 1
    ...
    companion object {
         ...
         * @return A new instance of fragment CharityOrdersFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CharityOrdersFragment().apply {
    ...
    private fun showEmptyLayout() {
        ...
        binding?.recListOfCharityOrders?.showView(false)
    ...
    fun executeSearchCommand() {
        ...
        isFilterSelected = false
        mCurrentPage = 1
        orderData[ApiConstants.PAR_DATA] = binding?.edtCharityOrdersFragmentSearch?.text.toString()
        orderData[ApiConstants.PAR_PAGE] = mCurrentPage.toString()
        orderData.remove(ApiConstants.PAR_STATUS)
